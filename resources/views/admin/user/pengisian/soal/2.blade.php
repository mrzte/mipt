...
<table id="example1" class="table table-striped">
 ...
 <td>Pendidikan sudah menjadi hal <br>yang sangat penting untuk di perhatikan</td>
...
<a href="{{ route('soal1') }}"><button type="button" class="btn btn-primary" name="button">Prev</button></a> 
<button type="button" class="btn btn-primary" name="button">Skip</button>
